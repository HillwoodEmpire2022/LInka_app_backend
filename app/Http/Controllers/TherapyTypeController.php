...
use App\Packages\application\TherapyType\All\AllTherapyTypeService;
...
class TherapyTypeController extends Controller
{
    ...
    public function allTherapyType(AllTherapyTypeService $allTherapyTypeService){

        return $allTherapyTypeService->allTherapyType();
